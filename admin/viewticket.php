...
$clientdata = query_fetch_assoc( "SELECT firstname,lastname FROM `".DBPREFIX."client` WHERE `clientid` = '".$ticketdata['creator']."' LIMIT 1" );
...
<div class="well">
	...
	<table class="table table-striped table-bordered table-condensed">
		...
		<tr>
			<td>Client</td>
			<td><?php echo (htmlspecialchars($clientdata['firstname'], ENT_QUOTES).' '.htmlspecialchars($clientdata['lastname'],ENT_QUOTES));?></td>
		</tr>
		<tr>
			<td>Subject</td>
	...
	<div style="text-align:right">
		...
		<a href="ticketprocess.php?task=close&tid=<?php echo $tid;?>" class="btn btn-warning pull-midle" onclick="return confirm('Are you sure you want to close this ticket?')">Close Ticket</a>
	</div>
</div>
